...
class Agent:
    def __init__(self, seed):
        ...
        self.Q = {}
        self.pm = {}       # key -> [intensity, own(bool)] 疼く傷(減衰する作業記憶)
    ...
    def is_tabooed(self, state, ai):
        ...
        for k, (inten, is_own) in self.pm.items():
            if is_own: continue
            if inten * sim_entry(cand, k) > TABOO_TH:
                return True
        return False
...
if __name__ == "__main__":
    ...
    for seed in range(N_SEEDS):
        ...
        A_cache[seed] = dict(A.archive)   # 語りは生涯アーカイブから【v01.1】
